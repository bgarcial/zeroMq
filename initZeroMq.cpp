...
#define SOFA_ZEROMQPLUGIN_API
#else
#ifdef SOFA_BUILD_ZEROMQPLUGIN
#define SOFA_ZEROMQPLUGIN_API SOFA_EXPORT_DYNAMIC_LIBRARY
#else
...
extern "C" {
    SOFA_ZEROMQPLUGIN_API void initExternalModule();
    SOFA_ZEROMQPLUGIN_API const char* getModuleName();
    SOFA_ZEROMQPLUGIN_API const char* getModuleVersion();
    SOFA_ZEROMQPLUGIN_API const char* getModuleLicense();
    SOFA_ZEROMQPLUGIN_API const char* getModuleDescription();
    SOFA_ZEROMQPLUGIN_API const char* getModuleComponentList();
}
